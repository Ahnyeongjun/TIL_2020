...
import com.example.myapplication.LoginMain;
...
//            user.pushTokenToServer();
    ...
    private void requestLocationPermission() {
        ...
        Snackbar.make(mLayout, R.string.location_permission_rationale, Snackbar.LENGTH_INDEFINITE)
                .setAction(R.string.ok, v -> ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION}, REQUEST_LOCATION))
                .show();
    }
