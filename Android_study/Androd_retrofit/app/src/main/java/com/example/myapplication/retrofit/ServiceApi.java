...
import static com.example.myapplication.Cons.LOGIN_ADDITIONAL_URL;
import static com.example.myapplication.Cons.ORDER_ENQUEUE_URL;
import static com.example.myapplication.Cons.ORDER_TOKENREFRESH_URL;
import static com.example.myapplication.Cons.REGISTER_ADDITIONAL_URL;
...
public interface ServiceApi
{
    ...
    Call<RegisterResult> resister(@Field("res_email") String res_email, // email을 id로 사용
                                  @Field("res_name") String res_name, @Field("res_pw") String res_pw, @Field("res_birth") String res_birth, @Field("res_address") String res_address, @Field("res_phone") String res_phone, @Field("res_token") String res_token);
