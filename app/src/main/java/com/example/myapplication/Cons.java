...
public class Cons
{
    //public static final String BASE_URL = "http://10.156.147.102:3000/search"; // 에뮬레이터에서 localhost에 접근하기 위해서는 10.0.2.2 주소로 접근해야함!!!!!
    public static final String BASE_URL = "http://10.156.147.102:3000/search";
